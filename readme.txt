...
Installing "Fastcase Opinions" can be done either by searching for "Fastcase Opinions" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
